...
const OrderProducts = ({ products, addToCart, repurchaseQuantities }) => {
  const orderColumns = [
    {
      title: "No.",
      dataIndex: "no",
    ...
    },
    {
      ...
      render: (_, record) => {
        const totalRepurchaseQuantity =
          repurchaseQuantities[record.product_id] || 0;
        const isAddToCartDisabled = totalRepurchaseQuantity >= record.quantity;
